...
Olist_db_ = pd.read_csv('C:\OLIST\deploy\Olist_db_ALS.csv')
Olist = pd.read_csv('C:\OLIST\deploy\Olist_Recommendation_Dataset.csv')
Olist_details_all = pd.read_csv('C:\OLIST\deploy\Recomm_Customer2vec.csv')
Orders_details_control = pd.read_csv('C:\OLIST\deploy\Loyalists.csv')

X = pd.read_csv('C:\OLIST\deploy\Olist_Recommendation_Dataset.csv', index_col=0)
...
#with open('C:\OLIST\deploy\SVD_ALS_model.pkl', 'rb') as f:
   # SVD = pickle.load(f)
